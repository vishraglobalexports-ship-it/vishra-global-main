...
export const ARTICLES: Article[] = [
  {
    ...
    content: {
      intro: 'India accounts for over 70% of the world’s Basmati rice production. Known as the "King of Rice," authentic Indian Basmati is renowned for its slender grain length, natural aroma, and non-sticky texture upon cooking. At Vishra Global Exports (Vishra Exports), we process and export top-tier Basmati grades directly to international buyers across North America, the Middle East, Europe, and Asia.',
      sections: [
        {
          heading: '1. Technical Specifications of 1121 Extra Long Grain Basmati',
          body: 'The 1121 Basmati variety holds the world record for longest raw grain length, averaging 8.30 mm to 8.35 mm raw, expanding to over 20 mm upon cooking (2.5x elongation ratio). Moisture content is strictly controlled under 12.5% max, with purity maintained at 95% minimum and zero chalky grains.'
        },
        {
          heading: '2. Golden Sella & Creamy Parboiled Basmati',
        ...
        {
          heading: '3. APEDA Certification & Container Packaging Standards',
          body: 'All Basmati consignments are inspected and certified by APEDA (Agricultural and Processed Food Products Export Development Authority). Packaging options include 5kg, 10kg, 20kg, 25kg, and 50kg PP, Non-Woven, or Jute bags with custom OEM private labeling. Containers are loaded with 24 to 25 Metric Tons in standard 20ft dry ocean freight containers.'
        }
      ],
  ...
  },
  {
    ...
    content: {
      intro: 'Andhra Pradesh is the rice bowl of South India. Sona Masuri, a lightweight, low-starch aromatic medium grain rice, is cultivated extensively in the fertile Godavari river delta. Vishra Global Exports supplies double silky polished Sona Masuri, IR64, Swarna, and Ponni rice to international importers.',
      sections: [
        {
          heading: '1. Sona Masuri Rice Characteristics',
          body: 'Sona Masuri is highly valued for its health benefits, low glycemic index, and easy digestibility. Double silky polishing removes all outer husk residue while retaining natural grain sheen. Broken grain percentages are maintained under 5% max.'
        },
        {
          heading: '2. IR64 White Rice for Global Distribution',
          body: 'IR64 is a long-grain non-basmati rice variety widely consumed across Africa, Southeast Asia, and the Gulf regions. Known for its strong grain integrity, high volume expansion, and competitive bulk pricing.'
        },
        {
          heading: '3. Quality Inspections & Port Logistics',
      ...
      sections: [
        {
          ...
          body: 'Black Tiger prawns possess a bolder, richer flavor profile compared to white shrimp. When cooked, their shells turn a vibrant red hue with pristine snow-white meat, making them stunning centerpiece dishes.'
        },
        {
